...
class UGVOnDeviceNode(Node):
  def __init__(self):
      ...
      # Bilddimensioner (640x640 kvadratiskt för att matcha din YOLOv8-pose-blob)
      self.img_w = 640
      self.img_h = 640  
      ...
      # A. INITIERA ROS-NODEN & PUBLISHER
  ...
  def run_loop(self):
      ...
      if latest_packet is not None:
          ...
          # MÄTNING 1: OAK-D HÅRDVARULATENS (Inkluderar YOLO-inferens)
          ...
          # MÄTNING 2: KOD- & PNP-LATENS PÅ NUC
